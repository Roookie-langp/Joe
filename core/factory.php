...
?>
			...
			<link rel="stylesheet" href="<?php Helper::options()->themeUrl('assets/static/APlayer.min.css'); ?>">
			<link rel="stylesheet" href="<?php Helper::options()->themeUrl('assets/static/prism-onedark.min.css'); ?>">
        ...
        <script>
			...
			<script src="<?php Helper::options()->themeUrl('assets/static/APlayer.min.js'); ?>"></script>
			<script src="<?php Helper::options()->themeUrl('assets/static/prism.min.js'); ?>"></script>
			<!--
