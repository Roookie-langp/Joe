...
<head>
	<?php $this->need('public/include.php'); ?>
		<link rel="stylesheet" href="<?php $this->options->themeUrl('assets/static/swiper.min.css'); ?>" />
		<script src="<?php $this->options->themeUrl('assets/static/swiper.min.js'); ?>"></script>
		<script src="<?php $this->options->themeUrl('assets/static/wow.min.js'); ?>"></script>
	<!--
